...
data class saveHistory(var date: String = "", var amount: Double = 0.0, var type: String = ""){
...
fun savedtHistory(user: Customer){
    val name = user.name
        ...
        try {
            ...
            if(amount == "e") {
                ...
                if ((money >= (amount?.toDouble()!!))&& wdAmount!! >= 0) {
                    ...
                    print("Invalid/Insufficient Balance. Please enter value that not exceed to your balance: ")
                }
            }
        } catch (e: Exception) {
